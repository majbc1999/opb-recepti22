...
<table class="tabela" id="recepti">
    <tr class="prva-vrstica">
        <td>
            <form action="{{url('uredi_kategorija', param='ime', kategorija=izb_kategorija)}}" method="get">
                <a href="#" onclick="this.parentElement.submit()" class="th-link" style="color: black;">ime recepta ⏷</a>
            </form>
        </td>
        <td>
            <form action="{{url('uredi_kategorija', param='st_porcij', kategorija=izb_kategorija)}}" method="get">
                <a href="#" onclick="this.parentElement.submit()" class="th-link" style="color: black;">število porcij ⏷</a>
            </form>
        </td>
        <td>
            <form action="{{url('uredi_kategorija', param='cas_priprave', kategorija=izb_kategorija)}}" method="get">
                <a href="#" onclick="this.parentElement.submit()" class="th-link" style="color: black;">čas priprave ⏷</a>
            </form>
        </td>
        <td>
            <form action="{{url('uredi_kategorija', param='cas_kuhanja', kategorija=izb_kategorija)}}" method="get">
