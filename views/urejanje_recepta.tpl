...
<form action="{{url('izbrisi_recept_id', id=recept.id)}}" method="POST">
...
<div class="flex-container">
    ...
    <div>
        ...
        <table class="tabela" id="sestavine_recepta" style="width:100%">
            ...
            <tr class="vrstica">
                ...
                <td>
                    <form action="{{url('brisi_sestavino', id=recept.id)}}" method="POST">
        ...
        <form action="{{url('dodaj_sestavino', id=recept.id)}}" method="POST">
    ...
    <div>
        ...
        <table class="tabela" id="postopek">
            ...
            <tr class="vrstica">
                ...
                <td>
                    <form action="{{url('brisi_postopek', id=recept.id)}}" method="POST">
                        <button class="gumb" name="korak" value="{{korak.postopek}}" type="submit">Izbriši</button>
                    </form>
                </td>
                <td>
                    <form action="{{url('uredi_postopek',id=recept.id)}}" method="POST">
        ...
        <form action="{{url('dodaj_postopek_post', id=recept.id)}}" method="POST">
    ...
    <div class="okvir">
        ...
        <div class="podatki" style="display: flex;height: 25px;">
            ...
            <form action="{{url('izbrisi_kategorijo', id=recept.id)}}" method="POST">
        ...
        <div class="podatki" style="display: flex;height: 25px;">
            ...
            <form action="{{url('izbrisi_kulinariko', id=recept.id)}}" method="POST">
        ...
        <div class="podatki" style="display: flex;height: 25px;">
            ...
            <form action="{{url('izbrisi_oznako', id=recept.id)}}" method="POST">
...
<div class="v-vrsto">
<form action="{{url('dodaj_kategorijo', id=recept.id)}}" method="POST">
    <h3>Kategorije</h3>
...
<form action="{{url('dodaj_kulinariko', id=recept.id)}}" method="POST">
    <h3>Kulinarike</h3>
...
<form action="{{url('dodaj_oznako', id=recept.id)}}" method="POST">
    <h3>Oznake</h3>
